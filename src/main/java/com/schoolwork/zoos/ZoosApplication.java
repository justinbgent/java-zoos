...
public class ZoosApplication {
    private static final Logger logger = LoggerFactory.getLogger(ZoosApplication.class);
    ...
    public static void main(String[] args) {
        ...
        if (!stop){
            ApplicationContext context = SpringApplication.run(ZoosApplication.class, args);
